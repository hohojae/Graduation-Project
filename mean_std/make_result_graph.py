...
with open("./songs1_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class1 = list(rd)
    x1, y1 = [], []
    x_1, y_1 = [], []
    ...
    for i in y_1:
        i = float(i[0])
        y1.append(i)
with open("./songs2_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class2 = list(rd)
    x2, y2 = [], []
    x_2, y_2 = [], []
    ...
    for i in y_2:
        i = float(i[0])
        y2.append(i)
with open("./songs3_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class3 = list(rd)
    x3, y3 = [], []
    x_3, y_3 = [], []
    ...
    for i in y_3:
        i = float(i[0])
        y3.append(i)
with open("./songs4_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class4 = list(rd)
    x4, y4 = [], []
    x_4, y_4 = [], []
    ...
    for i in y_4:
        i = float(i[0])
        y4.append(i)
with open("./songs5_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class5 = list(rd)
    x5, y5 = [], []
    x_5, y_5 = [], []
    ...
    for i in y_5:
        i = float(i[0])
        y5.append(i)
with open("./songs6_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class6 = list(rd)
    x6, y6 = [], []
    x_6, y_6 = [], []
    ...
    for i in y_6:
        i = float(i[0])
        y6.append(i)
with open("./songs7_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class7 = list(rd)
    x7, y7 = [], []
    x_7, y_7 = [], []
    ...
    for i in y_7:
        i = float(i[0])
        y7.append(i)
with open("./songs8_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class8 = list(rd)
    x8, y8 = [], []
    x_8, y_8 = [], []
    ...
    for i in y_8:
        i = float(i[0])
        y8.append(i)
with open("./songs9_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class9 = list(rd)
    x9, y9 = [], []
    x_9, y_9 = [], []
    ...
    for i in y_9:
        ...
        y9.append(i)
'''
with open("./songs_ver2/mean_std.csv", "r") as f:
    rd = csv.reader(f)
    class_ = list(rd)
    x, y = [], []
    x_, y_ = [], []
...
plt.savefig("mean_std_result_ver2.png")
plt.show()
